...
- [.agents/foundation/rules/blade.md](.agents/foundation/rules/blade.md) — Laravel Blade templating rules. Reference when editing files matching `resources/views/**/*.blade.php`.
- [.agents/foundation/rules/tailwind.md](.agents/foundation/rules/tailwind.md) — TailwindCSS rules. Reference when editing files matching `resources/views/**/*.blade.php`.
- [.agents/foundation/rules/javascript.md](.agents/foundation/rules/javascript.md) — JavaScript style rules (including Alpine.js within Blade). Reference when editing files matching `resources/views/**/*.js` or `resources/views/**/*.blade.php`.
